...
import com.diogoamorim.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Diogo Developer", "diogo.developer.dias@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,encrypt.encode("4587924"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
			
		Cliente cli2 = new Cliente(null, "Ana Costa", "testesilva@gmail.com", "314.012.860-62", TipoCliente.PESSOAFISICA,encrypt.encode("4587924"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27363323", "54484995495"));
		
		Cliente cli3 = new Cliente(null, "Dev", "dev@gmail.com", "314.012.860-62", TipoCliente.PESSOAFISICA,encrypt.encode("102030"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2047", "Sala 800", "Centro", "38777012", cli2, c2);
